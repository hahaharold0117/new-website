...
function MapEmbed({
  ...
  const q = hasCoords
    ? `${lat},${lng}`
    : encodeURIComponent(address ?? "Wolverhampton WV1 4LP");
...
export default function ContactHours() {
  ...
  return (
    <section className="py-10 bg-[#FFF8F5]">
          ...
          <div className="p-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start gap-3">
                <span className="inline-grid h-8 w-8 place-items-center rounded-lg bg-brand/10 text-brand">

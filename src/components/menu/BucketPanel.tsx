        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
            ...
            <div className="mb-4 flex items-center gap-2">
                <button
                    ...
                    className={`h-5 w-9 rounded-full transition-colors ${clickCollect ? "bg-brand" : "bg-neutral-300"
                        } relative`}
                >
                    <span
                        className={`absolute left-0.5 top-1/2 h-4 w-4 -translate-y-1/2 rounded-full bg-white transition-transform ${clickCollect ? "translate-x-4" : ""
                            }`}
                    />
                </button>
